    ...
    <footer className="border-t border-slate-100 bg-white px-6 py-4 mt-8">
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-4">
          <Link to="#" className="text-xs text-slate-400 hover:text-indigo-600 transition-colors">Copyright Policy</Link>
          <Link to="#" className="text-xs text-slate-400 hover:text-indigo-600 transition-colors">Terms</Link>
          <Link to="#" className="text-xs text-slate-400 hover:text-indigo-600 transition-colors">Privacy Policy</Link>
        </div>
      </div>
    </footer>
  );
