    ...
    <div className="min-h-screen bg-slate-50 dark:bg-gray-900">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
        <div className="mb-8">
          ...
          <p className="text-slate-500 text-sm mt-1 dark:text-gray-400">Update your instructor information</p>
        </div>

        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-7 dark:bg-gray-800 dark:border-gray-700">
          {/* Avatar */}
          <div className="flex items-center gap-5 mb-8 pb-8 border-b border-slate-100 dark:border-gray-700">
            <div className="relative">
              <img src={image || user.profileImg} alt="" className="w-20 h-20 rounded-2xl object-cover bg-slate-100 dark:bg-gray-700" />
            ...
            <div>
              <p className="font-bold text-slate-900 text-lg dark:text-white">{user.firstName} {user.lastName}</p>
              <p className="text-slate-500 text-sm dark:text-gray-400">{user.email}</p>
          ...
          {/* Guild info */}
          {user.guild && (
            <div className="mb-6 p-4 bg-slate-50 rounded-xl border border-slate-200 dark:bg-gray-900 dark:border-gray-600">
              <p className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-2 dark:text-gray-400">Guild</p>
