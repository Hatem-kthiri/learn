    ...
    <div className="min-h-screen bg-slate-50 dark:bg-gray-900">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="flex items-center gap-3 mb-8">
          <Link
            to="/students-list"
            className="w-9 h-9 rounded-xl bg-white border border-slate-200 hover:bg-slate-50 flex items-center justify-center text-slate-500 transition-colors dark:bg-gray-800 dark:border-gray-600 dark:hover:bg-gray-700 dark:text-gray-400"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 text-center dark:bg-gray-800 dark:border-gray-700">
            <img
              ...
              alt=""
              className="w-20 h-20 rounded-2xl object-cover bg-slate-100 mx-auto mb-4 dark:bg-gray-700"
            />
