        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-slate-500 text-sm mt-1 dark:text-gray-400">
              {studentsProgress.length} students in your guild
            </p>
          </div>
        </div>
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-slate-50 dark:divide-gray-700">
                {filtered.map((student, i) => (
                  <tr
                    key={student._id}
                    className="hover:bg-slate-50 transition-colors dark:hover:bg-gray-700"
                  >
                    <td className="px-4 py-4">
                      <span
                        className={`text-sm font-bold ${i === 0 ? "text-amber-500" : i === 1 ? "text-slate-400" : i === 2 ? "text-orange-400" : "text-slate-300"}`}
                      >
                        #{i + 1}
                      </span>
                    </td>
                    ...
                    <td className="px-4 py-4 min-w-[140px]">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs text-slate-500 flex-shrink-0 dark:text-gray-400">
